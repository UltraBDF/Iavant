  ...
  return (
    ...
    >
        ...
        <p>
          ...
          comme <b>Mosaic</b> (1993) puis <b>Netscape Navigator</b> (1994) rend Internet accessible
        ...
        <p>
          Tim Berners-Lee crée la toute première page web au CERN, expliquant le concept du World
          Wide Web. Voici à quoi elle ressemblait :
        </p>
        ...
        <p>
          Les premiers navigateurs graphiques transforment l'Internet en un média visuel
          accessible.
        </p>
        ...
        <p>
          Le Web des années 1990 est un terrain d'expérimentation et de découverte personnelle :
        </p>
        <ol>
          <li>
            <b>Consultation de pages web</b> : Découverte de contenus multimédia (images, parfois
            du son)
          </li>
          <li>
            ...
            <tr>
              <td>
                ...
                <p>
                  ...
                  <b>JavaScript</b> dynamique va permettre de créer des sites beaucoup plus riches
                  et interactifs, ouvrant la voie à l'ère communautaire.
                </p>
              </td>
            </tr>
          </table>
